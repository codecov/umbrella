...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        add_retention_policy("ta_timeseries_test_aggregate_hourly", "3 days"),
        add_retention_policy("ta_timeseries_branch_test_aggregate_hourly", "3 days"),
        add_retention_policy("ta_timeseries_test_aggregate_daily", "60 days"),
        add_retention_policy("ta_timeseries_branch_test_aggregate_daily", "60 days"),
    ]
