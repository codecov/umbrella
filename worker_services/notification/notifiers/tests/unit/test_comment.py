...
from worker_services.billing import BillingPlan
from worker_services.comparison import ComparisonContext, ComparisonProxy
from worker_services.comparison.overlays.critical_path import CriticalPathOverlay
from worker_services.comparison.types import Comparison, FullCommit
from worker_services.decoration import Decoration
from worker_services.notification.notifiers.base import NotificationResult
from worker_services.notification.notifiers.comment import CommentNotifier
from worker_services.notification.notifiers.mixins.message.helpers import (
    diff_to_string,
    format_number_to_str,
    sort_by_importance,
)
from worker_services.notification.notifiers.mixins.message.sections import (
...
from worker_services.notification.notifiers.tests.conftest import generate_sample_comparison
from worker_services.repository import EnrichedPull
from worker_services.yaml.reader import get_components_from_yaml
...
class TestCommentNotifier(object):
    ...
    async def test_build_message(
        ...
        expected_result = [
            ...
            f"",
            f"| [Files](test.example.br/gh/{repository.slug}/pull/{pull.pullid}?dropdown=coverage&src=pr&el=tree) | Coverage Δ | Complexity Δ | |",
            f"|---|---|---|---|",
    ...
    async def test_build_message_hide_complexity(
        ...
        expected_result = [
            ...
            f"Flags with carried forward coverage won't be shown. [Click here](https://docs.codecov.io/docs/carryforward-flags#carryforward-flags-in-the-pull-request-comment) to find out more.",
            f"",
            f"| [Files](test.example.br/gh/{repository.slug}/pull/{pull.pullid}?dropdown=coverage&src=pr&el=tree) | Coverage Δ | |",
            f"|---|---|---|",
...
class TestFileSectionWriter(object):
    ...
    async def test_filesection_no_extra_settings(self, sample_comparison, mocker):
        ...
        assert lines == [
            "| [Files](pull.link?dropdown=coverage&src=pr&el=tree) | Coverage Δ | |",
            "|---|---|---|",
    ...
    async def test_filesection_hide_project_cov(self, sample_comparison, mocker):
        ...
        assert lines == [
            "| [Files](pull.link?dropdown=coverage&src=pr&el=tree) | Patch % | Lines |",
            "|---|---|---|",
