...
def get_testruns_for_uploads(
    ...
    """Fetch all testruns for a list of upload IDs in a single query and group by upload_id."""
...
def process_flakes_for_commit(repo_id: int, commit_id: str):
    ...
    for upload in uploads:
        process_single_upload(upload, curr_flakes, repo_id, testruns_by_upload.get(upload.id, []))
        log.info(
