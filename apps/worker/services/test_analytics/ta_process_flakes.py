...
def process_flakes_for_commit(repo_id: int, commit_id: str):
    ...
    # Evaluate uploads eagerly so we can batch-fetch testruns
    ...
    # Persist expired flakes (those that reached 30 consecutive passes) in bulk
    if expired_flakes:
