...
def process_testruns_for_upload(
...
def process_flakes_for_commit(repo_id: int, commit_id: str):
    ...
    all_testruns = list(get_testruns_for_uploads(uploads))
    ...
    for upload in uploads:
        ...
        process_testruns_for_upload(upload_testruns, curr_flakes, repo_id, expired_flakes)
        log.info(
