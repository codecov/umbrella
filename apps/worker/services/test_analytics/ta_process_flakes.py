...
def process_single_upload(
    ...
    """Process testruns for a single upload. Returns the list of testruns for bulk_update."""
    for testrun in testruns:
...
def process_flakes_for_commit(repo_id: int, commit_id: str):
    ...
    for upload in uploads:
        ...
        processed = process_single_upload(
    ...
    # Bulk update expired flakes (end_date set when recent_passes_count reached 30)
    if expired_flakes:
