...
def process_single_upload(
    ...
    """Process testruns for a single upload and return the list for bulk outcome update."""
    for testrun in testruns:
...
def process_flakes_for_commit(repo_id: int, commit_id: str):
    ...
    for upload in uploads:
        ...
        modified = process_single_upload(testruns, curr_flakes, expired_flakes, repo_id)
