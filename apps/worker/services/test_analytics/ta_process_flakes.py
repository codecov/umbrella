...
def process_flakes_for_commit(repo_id: int, commit_id: str):
    ...
    for upload in uploads:
        ...
        process_single_upload(upload_testruns, curr_flakes, repo_id, expired_flakes)
        all_modified_testruns.extend(upload_testruns)
        log.info(
    ...
    # Single bulk_update for flakes that expired (reached 30 recent passes)
    if expired_flakes:
