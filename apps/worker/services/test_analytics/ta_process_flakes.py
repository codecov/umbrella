...
def process_flakes_for_commit(repo_id: int, commit_id: str):
    ...
    testruns = list(get_testruns_for_uploads(upload_ids))

    # Group testruns by upload_id and process per upload
    ...
    for upload in uploads:
        ...
        process_testruns(upload_testruns, curr_flakes, repo_id)
        log.info(
