...
def get_testruns_for_uploads(
    ...
    returning a mapping of upload_id -> list of Testrun."""
...
def process_single_upload(
    ...
    """Process testruns for a single upload. Returns testruns whose outcome changed."""
...
def process_flakes_for_commit(repo_id: int, commit_id: str):
    ...
    for upload in uploads:
        ...
        modified = process_single_upload(testruns, curr_flakes, repo_id, expired_flakes)
        all_modified_testruns.extend(modified)
        log.info(
