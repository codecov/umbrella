...
from shared.helpers.redis import get_redis_connection, get_redis_connection_for_writes  # type: ignore
...
class LockManager:
    def __init__(
        ...
        self.redis_connection = redis_connection or get_redis_connection_for_writes()
