...
def comparison_100_percent_patch(sample_comparison):
    ...
    first_modified_file.append(17, ReportLine.create(0))
    first_modified_file.append(18, ReportLine.create(0))
    ...
    first_modified_file.append(23, ReportLine.create(0))
    first_modified_file.append(24, ReportLine.create(0))
    first_report.append(first_modified_file)
    second_modified_file = ReportFile("modified.py")
    second_modified_file.append(18, ReportLine.create(0))
    second_modified_file.append(19, ReportLine.create(0))
    second_modified_file.append(20, ReportLine.create(0))
    second_modified_file.append(21, ReportLine.create(0))
    second_modified_file.append(22, ReportLine.create(0))
    second_modified_file.append(23, ReportLine.create(1))
