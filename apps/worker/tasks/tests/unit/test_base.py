...
class TestBaseCodecovTask:
    ...
    def test_run_success_commits_sqlalchemy(self, mocker, dbsession):
        mock_cleanup = mocker.patch("tasks.base.BaseCodecovTask._cleanup_task_session")
        ...
        assert mock_cleanup.call_args_list == [call(dbsession)]
...
class TestBaseCodecovTaskApplyAsyncOverride:
    ...
    def test_apply_async_override(self, mocker):
        mock_create_task_session = mocker.patch("tasks.base.create_task_session")
