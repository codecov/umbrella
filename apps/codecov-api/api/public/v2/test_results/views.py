...
class TestResultsView(
    ...
    def dispatch(self, request, *args, **kwargs):
        """
        Override dispatch to return deprecation response for all requests
        """
        return JsonResponse(
            {
    ...
    @extend_schema(summary="Test results list (DEPRECATED)")
    def list(self, request, *args, **kwargs):
        """
        DEPRECATED: This endpoint has been deprecated. Please use /test-analytics/ instead.
    ...
    @extend_schema(
        summary="Test results detail (DEPRECATED)",
        parameters=[
            OpenApiParameter(
                "id",
                OpenApiTypes.INT,
