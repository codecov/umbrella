...
class CurrentUserViewTests(APITestCase):
    def setUp(self):
        ...
        self.owner1.profile.default_org = self.owner3
    ...
    def test_current_user_authenticated(self):
        ...
        assert data == {
            ...
            "default_org": self.owner3.username,
        }
    ...
    def test_current_user_authenticated_no_default_org(self):
        self.owner1.profile.default_org = None
        self.owner1.profile.save()
        self.client.force_login(self.user)
        res = self.client.get(reverse("current-user"))
        assert res.status_code == 200
