...
class AsyncGraphqlView(GraphQLAsyncView):
    ...
    def error_formatter(self, error: Any, debug: bool = False) -> dict[str, Any]:
        ...
        # original_error is None for GraphQL parse/validation errors (client mistakes)
        ...
        if is_graphql_validation_error:
            # GraphQL parse/validation errors are client-side mistakes; don't log or
            # send to Sentry as internal server errors.
            pass
