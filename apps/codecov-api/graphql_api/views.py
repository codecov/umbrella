...
class AsyncGraphqlView(GraphQLAsyncView):
    ...
    def error_formatter(self, error: Any, debug: bool = False) -> dict[str, Any]:
        ...
        # When original_error is None, the error was raised directly by the
        # GraphQL runtime (e.g. variable coercion / schema validation errors).
        # These are client errors — return the descriptive message as-is
        # and do not capture them as Sentry exceptions.
