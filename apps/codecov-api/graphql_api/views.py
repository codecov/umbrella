...
class AsyncGraphqlView(GraphQLAsyncView):
    ...
    def error_formatter(self, error: Any, debug: bool = False) -> dict[str, Any]:
        ...
        # GraphQL schema validation errors have no original_error (they are raised
        # by the GraphQL engine itself, not by resolver code). These are client
        # mistakes and should never be captured as internal server errors.
