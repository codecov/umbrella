...
class AsyncGraphqlView(GraphQLAsyncView):
    ...
    def error_formatter(self, error: Any, debug: bool = False) -> dict[str, Any]:
        ...
        # GraphQL engine validation errors (e.g. invalid variable types, unknown
        # fields) have no original_error — they are client mistakes, not server bugs.
        original_error = error.original_error
        is_bad_query = original_error is None or "Cannot query field" in error.formatted["message"]
