...
class AsyncGraphqlView(GraphQLAsyncView):
    ...
    def error_formatter(self, error: Any, debug: bool = False) -> dict[str, Any]:
        ...
        # if there is no original_error, it's a native GraphQL protocol/validation
        # error (e.g. bad variable type, coercion failure) caused by the client
        # — return it as-is without logging or sending to Sentry
