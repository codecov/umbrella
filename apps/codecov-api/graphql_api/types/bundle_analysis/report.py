...
from services.bundle_analysis import BundleAnalysisReport, BundleData, BundleReport, BundleSize
...
@bundle_analysis_report_bindable.field("assetSize")
def resolve_asset_size(
    bundle_analysis_report: BundleAnalysisReport, info: GraphQLResolveInfo
) -> BundleSize:
