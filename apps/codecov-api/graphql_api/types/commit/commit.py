...
@sync_to_async
def resolve_commit_bundle_analysis_total_size(commit: Commit, info) -> int | None:
    bundle_analysis_report = load_bundle_analysis_report(commit)
    if isinstance(bundle_analysis_report, BundleAnalysisReport):
...
@sync_to_async
def resolve_commit_bundle_analysis_total_load_time(commit: Commit, info) -> int | None:
    bundle_analysis_report = load_bundle_analysis_report(commit)
    if isinstance(bundle_analysis_report, BundleAnalysisReport):
