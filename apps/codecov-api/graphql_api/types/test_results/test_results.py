...
def resolve_total_duration(testrun: dict[str, Any], _: GraphQLResolveInfo) -> float:
    return testrun.get("total_duration") or 0.0


@test_result_bindable.field("lastDuration")
def resolve_last_duration(testrun: dict[str, Any], _: GraphQLResolveInfo) -> float:
    return testrun.get("last_duration") or 0.0
