...
@wrap_error_handling_mutation
@require_authenticated
async def resolve_regenerate_upload_token(
...
error_regenerate_upload_token = UnionType("RegenerateUploadTokenError")
error_regenerate_upload_token.type_resolver(resolve_union_error_type)