...
# Deprecated aliases for backward compatibility with external clients
coverage_totals_bindable.set_alias("hitCount", "hits")
coverage_totals_bindable.set_alias("missCount", "misses")
coverage_totals_bindable.set_alias("partialCount", "partials")
coverage_totals_bindable.set_alias("branchCount", "branches")
coverage_totals_bindable.set_alias("methodCount", "methods")
