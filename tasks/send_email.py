...
import worker_services.smtp
from worker_app import celery_app
from database.models import Owner
from helpers.email import Email
from helpers.metrics import metrics
from worker_services.template import TemplateService
...
class SendEmailTask(BaseCodecovTask, name=send_email_task_name):
    def run_impl(
        ...
        with metrics.timer("worker.tasks.send_email"):
            ...
            smtp_service = worker_services.smtp.SMTPService()
            ...
            with metrics.timer("worker.tasks.send_email.send"):
                ...
                except worker_services.smtp.SMTPServiceError as exc:
                    err_msg = str(exc)
